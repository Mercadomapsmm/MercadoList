...
export const CONTRAST_THEMES: Record<ContrastThemeId, ContrastThemeConfig> = {
  ...
  'ambar-dourado': {
    ...
    bgStickyHeader: 'bg-[#221303]/98 backdrop-blur-md',
    borderStickyHeader: 'border-amber-400',
    bgAccessibility: 'bg-[#221303] text-amber-200',
    borderAccessibility: 'border-amber-400/80',
    titleColor: 'text-amber-400 drop-shadow-[0_2px_12px_rgba(245,158,11,0.6)] font-black',
    accentBar: 'bg-amber-400 shadow-[0_0_8px_rgba(245,158,11,0.8)]',
    bgCard: 'bg-[#2a1705]',
  ...
  'magenta-neon': {
    ...
    bgStickyHeader: 'bg-[#22071e]/98 backdrop-blur-md',
    borderStickyHeader: 'border-pink-400',
    bgAccessibility: 'bg-[#22071e] text-pink-200',
    borderAccessibility: 'border-pink-400/80',
    titleColor: 'text-pink-400 drop-shadow-[0_2px_12px_rgba(244,63,94,0.6)] font-black',
    accentBar: 'bg-pink-400 shadow-[0_0_8px_rgba(244,63,94,0.8)]',
    bgCard: 'bg-[#2c0a27]',
  ...
  'roxo-eletrico': {
    ...
    bgStickyHeader: 'bg-[#180a31]/98 backdrop-blur-md',
    borderStickyHeader: 'border-purple-400',
    bgAccessibility: 'bg-[#180a31] text-purple-200',
    borderAccessibility: 'border-purple-400/80',
    titleColor: 'text-purple-300 drop-shadow-[0_2px_12px_rgba(168,85,247,0.6)] font-black',
    accentBar: 'bg-purple-400 shadow-[0_0_8px_rgba(168,85,247,0.8)]',
    bgCard: 'bg-[#220e44]',
  ...
  'laranja-solar': {
    ...
    bgStickyHeader: 'bg-[#1f1006]/98 backdrop-blur-md',
    borderStickyHeader: 'border-orange-400',
    bgAccessibility: 'bg-[#1f1006] text-orange-200',
    borderAccessibility: 'border-orange-400/80',
    titleColor: 'text-orange-400 drop-shadow-[0_2px_12px_rgba(251,146,60,0.6)] font-black',
    accentBar: 'bg-orange-400 shadow-[0_0_8px_rgba(251,146,60,0.8)]',
    bgCard: 'bg-[#2c1709]',
  ...
  'solar-creme': {
    ...
    bgStickyHeader: 'bg-[#FEF9C3]/98 backdrop-blur-md',
    borderStickyHeader: 'border-amber-700',
    bgAccessibility: 'bg-[#FEF9C3] text-[#451A03]',
    borderAccessibility: 'border-amber-700/80',
    titleColor: 'text-[#92400E] drop-shadow-sm font-black',
    accentBar: 'bg-[#B45309]',
    bgCard: 'bg-[#FFFDF0]',
